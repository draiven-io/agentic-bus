...
Usage::
    ...
    # 3. Run this demo:
    python -m agentic_bus.agents.examples.logistics_agent.demo_intent

Pre-requisites:
    - Agents seeded: ``python -m agentic_bus.agents.examples.logistics_agent.seed_managed_agents``
"""
...
from agentic_bus.agents.requester import IntentClient, PlanDecision
